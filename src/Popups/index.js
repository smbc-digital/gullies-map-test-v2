...
const gulliesActivePopup = feature => {
  ...
  return `<div> <p class="smbc-body govuk-!-font-size-14 govuk-!-margin-0 smbc-!-font-color-white">Location</p>
  <p class="smbc-body govuk-!-margin-bottom-4 govuk-!-margin-top-0 smbc-!-font-color-white">${feature.properties.street}</p></div>
